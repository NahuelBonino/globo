...
public class Crtl_Objetivos_lvl3 : MonoBehaviour
{
    ...
    private globo_spawn_lvl3 spawner;
        ...
        if (instance == null)
        {
           ...
           // DontDestroyOnLoad(this.gameObject);
            ...
            //Rest of your Awake code
             ...
             spawner =  GameObject.Find("spawner").GetComponent(typeof(globo_spawn_lvl3)) as globo_spawn_lvl3;
    ...
    public static Crtl_Objetivos_lvl3 getInstance()
    {
        return instance;
    }
